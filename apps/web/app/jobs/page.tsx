  ...
  const jobs = [
    {
      ...
      description: "We're looking for an experienced frontend developer to help build the future of online payments..."
    },
    {
      id: 2,
      ...
      description: "Join our design team to craft beautiful experiences for millions of developers worldwide..."
    },
    {
      id: 3,
      ...
      description: "Help us build the best issue tracking tool for high-performance teams..."
    },
    {
      id: 4,
      ...
      description: "Build and ship features for our mobile app used by millions of users every day..."
    },
    {
      id: 5,
      ...
      description: "Work on our open-source Firebase alternative, building scalable backend infrastructure..."
    },
    {
      id: 6,
      ...
      description: "Help scale our infrastructure platform that deploys millions of applications..."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-5xl mx-auto py-8 px-4">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-semibold text-zinc-900 mb-2">Job openings</h1>
